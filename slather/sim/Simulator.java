...
class Simulator {
	...
	// group players
	private static String[] groups = {"slather/g0", "slather/g0", "slather/g0", "slather/g0", "slather/g0", "slather/g0", "slather/g0", "slather/g0", "slather/g0", "slather/g0"};
	private static Class[] player_classes;
	private static Player[] players;
	private static int[] score;
	private static slather.Timer[] threads;
			...
			throws UnknownServiceException
	{
		...
		for (;;) {
			...
			// send file
			File file = new File(/*root + File.separator + */"slather/sim"
					+ File.separator + path);
			try {
				server.reply(file);
